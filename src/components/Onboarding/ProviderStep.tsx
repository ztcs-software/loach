...
const OLLAMA_CATALOG: {
...
}[] = [
  {
    ...
    variants: [
      { tag: "gemma4:e2b", label: "E2B", size: "~1.5 GB" },
      { tag: "gemma4:e4b", label: "E4B", size: "~3 GB" },
      { tag: "gemma4:26b-a4", label: "26B A4 (MoE)", size: "~16 GB" },
      { tag: "gemma4:31b", label: "31B", size: "~19 GB" },
    ],
  },
  {
    family: "Qwen 3.5",
    ...
    variants: [
      { tag: "qwen3.5:0.8b", label: "0.8B", size: "~600 MB" },
      { tag: "qwen3.5:2b", label: "2B", size: "~1.4 GB" },
      { tag: "qwen3.5:4b", label: "4B", size: "~2.5 GB" },
      { tag: "qwen3.5:9b", label: "9B", size: "~5.5 GB" },
      { tag: "qwen3.5:27b", label: "27B", size: "~16 GB" },
      { tag: "qwen3.5:35b-a3b", label: "35B A3B (MoE)", size: "~21 GB" },
      { tag: "qwen3.5:122b-a10b", label: "122B A10B (MoE)", size: "~74 GB" },
    ],
  },
  {
    family: "Qwen 3.6",
    ...
    variants: [
      { tag: "qwen3.6:27b", label: "27B", size: "~16 GB" },
      { tag: "qwen3.6:35b-a3b", label: "35B A3B (MoE)", size: "~21 GB" },
    ],
  },
  {
    family: "Ministral 3",
    ...
    variants: [
      { tag: "ministral-3:3b", label: "3B", size: "~2 GB" },
      { tag: "ministral-3:8b", label: "8B", size: "~5 GB" },
      { tag: "ministral-3:14b", label: "14B", size: "~8.5 GB" },
    ],
  },
  {
    family: "Minimax M2.7",
    url: "https://ollama.com/library/minimax-m2.7",
    variants: [{ tag: "minimax-m2.7", label: "default", size: "~4 GB" }],
  },
];
